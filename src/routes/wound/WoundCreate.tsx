...
type WoundTypeKey = TwoCharString;
...
const WoundCreate: React.FC<WoundCreateProps> = ({woundRegion, woundTypes}) => {
    ...
    const watchRegion = watch('wound_region') as WoundRegionKey;
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent>
                                    {watchRegion && woundRegion[watchRegion]?.subregions
                                        && Object.entries(woundRegion[watchRegion].subregions as Record<string, string>).map(([key, value]) => (
                                            <SelectItem key={key} value={key}>
                                                {value}
                                            </SelectItem>
                                        ))}
